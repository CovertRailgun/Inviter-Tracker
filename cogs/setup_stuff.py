...
class Bot_Setup(commands.Cog):
    ...
    @commands.slash_command(description="Owner command")
    @commands.is_owner()
    async def z_cog(self, inter:disnake.ApplicationCommandInteraction) -> None:
        pass

    @z_cog.sub_command(description="Owner command")
    ...
    @z_cog.error    
    async def z_cog_error_handler(self, inter:disnake.ApplicationCommandInteraction, error):
